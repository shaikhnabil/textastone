# Generated by Django 5.0.1 on 2024-02-20 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_image', models.ImageField(upload_to=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('merchent_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='merchent', to=settings.AUTH_USER_MODEL)),
